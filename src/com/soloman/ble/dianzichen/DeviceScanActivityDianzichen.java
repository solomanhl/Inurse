...
import com.soloman.ble.dianzichen.BluetoothLeClassDianzichen.OnDataAvailableListener;
import com.soloman.ble.dianzichen.BluetoothLeClassDianzichen.OnServiceDiscoverListener;
 ...
 */
public class DeviceScanActivityDianzichen extends ListActivity {
	private final static String TAG = DeviceScanActivityDianzichen.class.getSimpleName();
	//电子秤的
	private final static String UUID_KEY_SERVICE = "00001950-0000-1000-8000-00805f9b34fb";
	private final static String UUID_KEY_DATA_SEND = "00002a6c-0000-1000-8000-00805f9b34fb"; //write
	private final static String UUID_KEY_DATA_RECIV = "00002a6d-0000-1000-8000-00805f9b34fb"; //read
	private final static String CCC = "00002902-0000-1000-8000-00805f9b34fb"; //CCC DESCRIPTOR notify
	
	public BluetoothGatt mBluetoothGatt = null;	//全局bluetoothgatt
	
    private LeDeviceListAdapterDianzichen mLeDeviceListAdapter;
    /**搜索BLE终端*/
    private BluetoothAdapter mBluetoothAdapter;
    /**读写BLE终端*/
    private BluetoothLeClassDianzichen mBLE_send, mBLE_reciv;
    ...
    protected void onResume() {
        ...
        mLeDeviceListAdapter = new LeDeviceListAdapterDianzichen(this);        	
...
//        mBLE_reciv.close();
     ...
     * 搜索到BLE终端服务的事件
     */
    private BluetoothLeClassDianzichen.OnServiceDiscoverListener mOnServiceDiscover = new OnServiceDiscoverListener(){
     ...
     * 收到BLE终端数据交互的事件
     */
    private BluetoothLeClassDianzichen.OnDataAvailableListener mOnDataAvailable = new OnDataAvailableListener(){
                ...
                public void run() {
                  ...
                  //自动连接功能-------------------------------------------
                    ...
                    if ( appState.file.isFileExist("inurse/Dianzichen.txt") ){
                    	lastDevice =  appState.file.readFile(appState.file.SDPATH + "inurse/Dianzichen.txt");
                    }
                    
                    //如果和上次的相等，就直接连接
                    if (lastDevice.equals(device.getAddress())){
                    	appState.file.write2SDFromInput("inurse/", "Dianzichen.txt", device.getAddress());                    	
                        ...
                        appState.mBLE_reciv_dianzichen.connect(device.getAddress());
                        appState.mBLE_send_dianzichen.connect(device.getAddress());             
                    }else{
