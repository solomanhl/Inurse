 ...
 */
public class BluetoothLeClassDianzichen{
    private final static String TAG = BluetoothLeClassDianzichen.class.getSimpleName();
	...
	public BluetoothLeClassDianzichen(Context c){
		mContext = c;
	}
