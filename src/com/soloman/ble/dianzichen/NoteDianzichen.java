...
public class NoteDianzichen extends Activity {
	...
	public void btn_ok_onclick(View target) {
		...
		int resultCode = -1;
		//更新数据库
		appState.database.updateDianzichen(uid, date, ed_listnote.getText().toString());
		resultCode = 100;
		
		Intent rtnIntent = new Intent();
		NoteDianzichen.this.setResult( resultCode, rtnIntent);
		NoteDianzichen.this.finish();
	}
}
