...
import com.bluetooth.le.soloman.FragmentSetting;
...
public class DianzichenActivity extends FragmentActivity {
	...
	public FragmentDianzichenGraph fragmentDianzichenGraph;
	public FragmentDianzichenData fragmentDianzichenData;
	public FragmentDianzichenHelp fragmentDianzichenHelp;
//	public FragmentDianzichenSetting fragmentDianzichenSetting;
	public FragmentSetting fragmentDianzichenSetting;
...
//				viewPager.setCurrentItem(1);
				replaceFrag(new FragmentDianzichenGraph() );
...
//				viewPager.setCurrentItem(2);
				replaceFrag(new FragmentDianzichenData() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
...
//				viewPager.setCurrentItem(3);
				replaceFrag(new FragmentDianzichenHelp() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
				iv_data.setBackgroundResource(R.drawable.data);
