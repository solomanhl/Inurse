...
public class NoteUSBThemometer extends Activity {
	...
	public void btn_ok_onclick(View target) {
		...
		int resultCode = -1;
		//更新数据库
		appState.updateRecord(uid, date, ed_listnote.getText().toString());
		resultCode = 100;
		
		Intent rtnIntent = new Intent();
		NoteUSBThemometer.this.setResult( resultCode, rtnIntent);
		NoteUSBThemometer.this.finish();
	}
}
