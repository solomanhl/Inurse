...
public class USBThemometerActivity extends FragmentActivity {

	public GlobalVar appState;
	
	public android.support.v4.app.FragmentTransaction ft;
	public FragmentUSBThemometer fragmentUSBThemometer;
	public FragmentUSBThemometerGraph fragmentUSBThemometerGraph;
	public FragmentUSBThemometerData fragmentUSBThemometerData;
	public FragmentUSBThemometerHelp fragmentUSBThemometerHelp;
...
//		initViewPager();
		...
		fragmentUSBThemometer = (FragmentUSBThemometer) fm.findFragmentById(R.layout.fragment_themometer);
		
		ft.add(R.id.frag_container,new FragmentUSBThemometer(), "home");
...
//				viewPager.setCurrentItem(0);
				replaceFrag(new FragmentUSBThemometer() );
				iv_celianghome.setBackgroundResource(R.drawable.home1);
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_data.setBackgroundResource(R.drawable.data);
				iv_celianghelp.setBackgroundResource(R.drawable.help);
...
//				viewPager.setCurrentItem(1);
				replaceFrag(new FragmentUSBThemometerGraph() );
...
//				viewPager.setCurrentItem(2);
				replaceFrag(new FragmentUSBThemometerData() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
...
//				viewPager.setCurrentItem(3);
				replaceFrag(new FragmentUSBThemometerHelp() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
				iv_data.setBackgroundResource(R.drawable.data);
