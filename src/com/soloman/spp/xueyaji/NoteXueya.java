...
public class NoteXueya extends Activity {
	...
	public void btn_ok_onclick(View target) {
		...
		int resultCode = -1;
		//更新数据库
		appState.database.updateXueya(uid, date, ed_listnote.getText().toString());
		resultCode = 100;
		
		Intent rtnIntent = new Intent();
		NoteXueya.this.setResult( resultCode, rtnIntent);
		NoteXueya.this.finish();
	}
}
