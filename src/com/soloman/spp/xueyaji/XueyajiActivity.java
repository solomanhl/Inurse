...
public class XueyajiActivity extends FragmentActivity {

	public GlobalVar appState;
	
	public android.support.v4.app.FragmentTransaction ft;
	public FragmentXueya fragmentXueya;
	public FragmentXueyaGraph fragmentXueyaGraph;
	public FragmentXueyaData fragmentXueyaData;
	public FragmentXueyaHelp fragmentXueyaHelp;
...
//		initViewPager();
		...
		fragmentXueya = (FragmentXueya) fm.findFragmentById(R.layout.frag_xueyaji);
		
		ft.add(R.id.frag_container,new FragmentXueya(), "home");
...
//				viewPager.setCurrentItem(1);
				replaceFrag(new FragmentXueyaGraph() );
...
//				viewPager.setCurrentItem(2);
				replaceFrag(new FragmentXueyaData() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
...
//				viewPager.setCurrentItem(3);
				replaceFrag(new FragmentXueyaHelp() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
				iv_data.setBackgroundResource(R.drawable.data);
