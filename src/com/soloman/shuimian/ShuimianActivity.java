...
public class ShuimianActivity extends FragmentActivity {
	...
	public FragmentShuimianGraph fragmentThemometerGraph;
	public FragmentShuimianData fragmentThemometerData;
	public FragmentShuimianrHelp fragmentThemometerHelp;
...
//				viewPager.setCurrentItem(1);
				replaceFrag(new FragmentShuimianGraph() );
...
//				viewPager.setCurrentItem(2);
				replaceFrag(new FragmentShuimianData() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
...
//				viewPager.setCurrentItem(3);
				replaceFrag(new FragmentShuimianrHelp() );
				iv_graph.setBackgroundResource(R.drawable.graph);
				iv_celianghome.setBackgroundResource(R.drawable.home);
				iv_data.setBackgroundResource(R.drawable.data);
