...
//		mCurrentRenderer = new XYSeriesRenderer();
	    ...
	    //1
	    String seriesTitle = "Body Series ";
//	    if ("body".equals(mode)){
...
//	    }
	    ...
	    seriesTitle2 = "Surface Series ";// + (mDataset.getSeriesCount() + 1);//图例  
...
//	            		  " Y = " + String.valueOf(seriesSelection.getValue()));
	            	if (seriesSelection.getSeriesIndex() == 0){//body series
	            	...
	            	}else if (seriesSelection.getSeriesIndex() == 1){//surface series
	            		tv_graphdata.setText(appState.userID + "  " 
		  	            		  + appState.userName + "  "
		  	            		  + value2[(int) seriesSelection.getXValue() - 1] + unit2[(int) seriesSelection.getXValue() - 1]  + "\n"
